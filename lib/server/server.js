...
// static routing
k_app.use('/scripts', express.static(path.join(PD_DIST_WEBAPP, 'scripts')));
k_app.use('/styles', express.static(path.join(PD_DIST_WEBAPP, 'styles')));
k_app.use('/resource', express.static(path.join(PD_LIB_WEBAPP, '_resources')));
k_app.use('/fonts', express.static(path.join(PD_ROOT, 'node_modules/font-awesome/fonts')));
