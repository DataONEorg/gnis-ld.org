...
// sparql
k_app.use('/sparql/*', proxy({target:'http://localhost:8080'}));
...
k_app.get([
	...
	d_res.redirect(`http://phuzzy.link/browse/gnis-ld.org/sparql/select#<http://${d_req.headers.host}${d_req.url}>`);
});


// // request for the page about the resource
// k_app.get([
// 	'/lod/page/usgs/ontology/:type',
// 	'/lod/page/gnis/ontology/:type',
// 	'/lod/page/nhd/ontology/:type',
// 	'/lod/page/gnis/feature/:id',
// 	'/lod/page/gnis/feature-alias/:alias',
// 	'/lod/page/nhd/feature/:id',
// ], (d_req, d_res) => {
// 	d_res.redirect(`http://phuzzy.link/browse/gnis-ld.org/sparql/select#<${d_req.url}>`);
// });

// (d_req, d_res) => {
// 	d_res.sendFile(path.resolve(path.join(__dirname, '/../../dist/webapp/_layouts/pub.html')));
// });

// // request for usgs ontology
// k_app.get([
// 	'/lod/usgs/ontology/:type',
// ], (d_req, d_res) => {
// 	d_res.redirect('/lod/page/usgs/ontology/'+d_req.params.type);
// });
...
// ], (d_req, d_res) => {
// 	d_res.redirect('/lod/page/gnis/ontology/'+d_req.params.type);
// });
...
// ], (d_req, d_res) => {
// 	negotiate_feature(d_req, d_res, '/lod/page/cegis/feature/'+d_req.params.id);
// });

// // request for the gnis feature
// k_app.get([
// 	'/lod/gnis/feature/:id',
// ], (d_req, d_res) => {
// 	negotiate_feature(d_req, d_res, '/lod/page/gnis/feature/'+d_req.params.id);
// });

// // request for the gnis feature alias
// k_app.get([
// 	'/lod/gnis/feature-alias/:alias',
// ], (d_req, d_res) => {
// 	negotiate_feature(d_req, d_res, '/lod/page/gnis/feature-alias/'+d_req.params.alias);
// });
...
// 	'/lod/nhd/feature/:id',
// ], (d_req, d_res) => {
// 	negotiate_feature(d_req, d_res, '/lod/page/nhd/feature/'+d_req.params.id);
// });
