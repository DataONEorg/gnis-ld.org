...
addJuneau = function() {
  tab = yasgui.addTab(
    true, // set as active tab
    { requestConfig: {"endpoint": "https://stage.gnis-ld.org:30443/sparql"}, name: "Juneau, Alaska" }
  );
...
addElevation = function() {
  tab = yasgui.addTab(
    true, // set as active tab
    { requestConfig: {"endpoint": "https://stage.gnis-ld.org:30443/sparql"}, name: "High Elevation" }
  );
  tab.setQuery(`  PREFIX gnis: <https:\/\/gnis-ld.org\/lod\/gnis\/ontology\/>
  PREFIX gnisf-alias: <https:\/\/gnis-ld.org\/lod/gnis\/feature-alias\/>
  PREFIX rdfs: <http:\/\/www.w3.org\/2000\/01\/rdf-schema#>
